package com.login.oa.controller;

import com.login.common.config.Constant;
import com.login.common.controller.BaseController;
...
import com.login.oa.service.NotifyRecordService;
...
public class NotifyController extends BaseController {
	...
	public PageData list(@RequestParam Map<String, Object> params) {
		...
		PageData pageData = new PageData(notifyList, total);
		return pageData;
	}
	...
	@ResponseBody
	@GetMapping("/selfList")
    PageData selfList(@RequestParam Map<String, Object> params) {
		Query query = new Query(params);
		query.put("userId", getUserId());
